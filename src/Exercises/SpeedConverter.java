...
public class SpeedConverter {
    ...
    public static void askForKilometersPerHour() {
        System.out.println("Type the number that represents the kilometers you would like to convert to miles: ");
    }
    /*
    Speed Converter
    ...
    public static long toMilesPerHour(double kilometersPerHour) {
        if (kilometersPerHour < 0) {
            ...
            return Math.round((kilometersPerHour * 1000) / 1609);
        }
    }
    ...
    public static void printConversion(double kilometersPerHour) {
        if (kilometersPerHour < 0) {
            ...
            System.out.printf("%.2f km/h = %d mi/h", kilometersPerHour, conversion);
        }
    }
}
